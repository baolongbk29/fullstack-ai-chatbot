...
import asyncio
from src.model.gpt2_medium_vn import GPT2_Medium_VN
...
async def main():
    ...
    while True:
        response = await consumer.consume_stream(stream_channel="message_channel", block=0)
        if response:
            for stream, messages in response:
                ...
                for message in messages:
                    ...
                    res = GPT2_Medium_VN().query(input=input)
